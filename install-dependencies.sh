...
if [ "$PREFIX_MATCH" != "" ] ; then
  ...
  if [ "$PYTHON" == "python" ] ; then
    ...
    wget "https://www.python.org/ftp/python/2.7.12/Python-2.7.12.tgz" || exit 1
#    echo "Verifying python"
#    echo "5eebcaa0030dc4061156d3429657fb83  Python-2.7.12.tgz" | md5sum -c - || exit 1
    tar xzf "Python-2.7.12.tgz" || exit 1
    cd "Python-2.7.12" || exit 1
